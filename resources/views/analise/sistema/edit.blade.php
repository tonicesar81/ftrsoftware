  ...
  <div class="card-body">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-6">
            ...
            {!! Form::select('grupos_id',$grupo ,$tipo_relatorios->grupos_id, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group col-12">
            ...
            {!! Form::textarea('detalhamento',$tipo_relatorios->detalhamento ,['class' => 'form-control summernote']) !!}
        </div>
        <div class="form-group col-12">
