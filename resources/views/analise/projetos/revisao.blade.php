        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-6 offset-md-2">
                    ...
                    {!! Form::text('loja', $loja, ['class' => 'form-control text-uppercase']); !!}
                </div>
                <div class="form-group col-2">
                    {!! Form::label('numero', 'Número da loja') !!}
                    {!! Form::text('numero', $numero, ['class' => 'form-control text-uppercase']); !!}
                </div>
                <div class="form-group col-8 offset-md-2">

                    {!! Form::label('tipo_relatorios', 'Escolha a disciplina a ser analisada') !!}
                    {!! Form::select('tipo_relatorios',$tipo_relatorio ,$tipo_relatorios_id, ['class' => 'form-control', 'id' => 'select-shopping']) !!}
                </div>
                <div class="form-group col-8 offset-md-2">
