...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['action' => ['DsnomesController@update', $nome->id], 'method' => 'put']) !!}
            <div class="form-row">
                <div class="form-group offset-md-3 col-md-6">
                    {!! Form::label('tipo_relatorios_id', 'Disciplina do equipamento') !!}
                    {!! Form::select('tipo_relatorios_id',$tipo_relatorio ,$nome->tipo_relatorios_id, ['class' => 'form-control']) !!}
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    {!! Form::text('nome_plural', $nome->nome_plural, ['class' => 'form-control']); !!}
                </div>
